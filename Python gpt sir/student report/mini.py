...
def create_teacher_interface():
    ...
    # Ensure database connection is closed when the window is closed
    teacher_window.protocol("WM_DELETE_WINDOW", lambda: close_db(conn) or teacher_window.destroy())
...
def create_student_interface():
    ...
    # Ensure database connection is closed when the window is closed
    student_window.protocol("WM_DELETE_WINDOW", lambda: close_db(conn) or student_window.destroy())
